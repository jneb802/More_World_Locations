...
namespace Common
{
    ...
    {
        internal const string ModName = "Common";
        ...
        public static readonly ManualLogSource CommonLogger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                CommonLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                CommonLogger.LogError($"There was an issue loading your {ConfigFileName}");
                CommonLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
